  ...
  Widget build(BuildContext context) {
    Widget _showcard(int index) {
      return GestureDetector(
          onTap: () {
            setState(() {
              category = Carlist[index].title;
              if (Carlist[index].isselected) {
                //
              } else {
                Carlist[index].isselected = true;
                print(Carlist[index].isselected);

                for (int i = 0; i < Carlist.length; i++) {
                  if (i != index) {
                    Carlist[i].isselected = false;
                  }
                }
              }
            });
          ...
          child: Card(
            child: Padding(
              ...
              child: Text(
                Carlist[index].title,
                style: TextStyle(
                    color: Carlist[index].isselected
                        ? Colors.redAccent
                        : Colors.black,
