  ...
  Widget build(BuildContext context) {
    Widget _showcard(int index) {
      return GestureDetector(
          onTap: () {
            setState(() {
              category = Attalist[index].title;
              if (Attalist[index].isselected) {
                //
              } else {
                Attalist[index].isselected = true;
                print(Attalist[index].isselected);

                for (int i = 0; i < Attalist.length; i++) {
                  if (i != index) {
                    Attalist[i].isselected = false;
                  }
                }
              }
            });
          ...
          child: Card(
            child: Padding(
              ...
              child: Text(
                Attalist[index].title,
                style: TextStyle(
                    color: Attalist[index].isselected
                        ? Colors.redAccent
                        : Colors.black,
    ...
    return Scaffold(
        appBar: AppBar(
          title: Text("Atta, Flours & Sooji",style: TextStyle(fontSize: displayWidth(context)*0.045),),
          leading: IconButton(
            onPressed:()
            {
