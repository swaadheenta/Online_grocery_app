...
class _HealthDrinksState extends State<HealthDrinks> {
  List<singlecard> HealthDrinkslist = [
    singlecard(
  ...
  Widget build(BuildContext context) {
    Widget _showcard(int index) {
      return GestureDetector(
        onTap: () {
          setState(() {
            category = HealthDrinkslist[index].title;
            if (HealthDrinkslist[index].isselected) {
              //Already selected and then tapped ,so do nothing !!
            } else {
              HealthDrinkslist[index].isselected = true;
              for (int i = 0; i < HealthDrinkslist.length; i++) {
                if (index != i) {
                  HealthDrinkslist[i].isselected = false;
                }
              }
            }
          });
        ...
        child: Card(
          child: Padding(
            ...
            child: Text(
              ...
              style: TextStyle(
                  color: HealthDrinkslist[index].isselected
                      ? Colors.redAccent
                      : Colors.black,
          ...
          Positioned(
              child: Container(
                  ...
                  child: ListView.builder(
                      itemCount: HealthDrinkslist.length,
